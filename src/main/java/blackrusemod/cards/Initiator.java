...
public class Initiator extends AbstractServantCard {
	public static final String ID = BlackRuseMod.makeID(Initiator.class.getSimpleName());
	public static final String IMG = BlackRuseMod.makeCardPath("initiator.png");

...
<<<<<<< HEAD
        ...
        BaseMod.addKeyword(new String[] {"±‰ªª"}, "±‰ªª –ßπ˚ª·‘⁄≈∆±ª ÷∂Ø∂™∆˙∫Û¥•∑¢°£");
        BaseMod.addKeyword(new String[] {" ”ΩÁ"}, "‘§≤‚µ–»Àœ¬ªÿ∫œµƒ“‚Õº°£»Áπ˚‘§≤‚’˝»∑‘Ú‘⁄ƒ„µƒœ¬∏ˆªÿ∫œø™ º ±¥•∑¢–ßπ˚°£");
        BaseMod.addKeyword(new String[] {"∑¥≥Â"}, "∂‘ƒ„∏Ωº” #b1 ≤„ #y–È»ı °¢ #y“◊…À ∫Õ #y¥‡»ı °£");
        BaseMod.addKeyword(new String[] {"ª§∂‹"}, "µ±ƒ„À ß…˙√¸ ±£¨œ˚∫ƒ #yª§∂‹ ∂¯≤ª «ƒ„µƒ…˙√¸°£ª§∂‹ƒ„µƒœ¬“ªªÿ∫œø™ º ±≤ªª·œ˚ ß°£");

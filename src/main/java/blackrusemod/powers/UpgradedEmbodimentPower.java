...
public class UpgradedEmbodimentPower extends AbstractPower {
	public static final String POWER_ID = "UpgradedEmbodimentPower";
	...
	public UpgradedEmbodimentPower(AbstractCreature owner, int amount) {
		...
		this.amount = amount;
		updateDescription();
		this.region48 = powerAltas.findRegion("upgraded_embodiment48");
		this.region128 = powerAltas.findRegion("upgraded_embodiment128");
	}
